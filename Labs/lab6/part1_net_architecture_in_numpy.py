...
def zad2_two_layer_net(student_id):
    ...
    class SimpleTwoLayerNetwork:
        ...
        def forward(self, x_data):
            h_output = self.hidden_layer.forward(x_data)
    ...
    model.hidden_layer.W[:, 1] = [0.3, 0.6]
    model.hidden_layer.b[:] = [0.15, -0.75]
    model.output_layer.W[:, 0] = [0.15, 0.45]
    model.output_layer.b[:] = -0.05
...
if __name__ == '__main__':
    ...
    student_id = 191550         # Twój numer indeksu, np. 102247
